...
namespace Jellyfin.Plugin.SegmentAnalyzer.Controllers;
...
public class SkipIntroController : ControllerBase
{
    ...
    private Intro? GetIntro(Guid id, AnalysisMode mode)
    {
        try
        {
            ...
            segment.ShowSkipPromptAt = Math.Max(0, segment.IntroStart - 5);
            segment.HideSkipPromptAt = segment.IntroStart + 10;
            segment.IntroEnd -= 2;
